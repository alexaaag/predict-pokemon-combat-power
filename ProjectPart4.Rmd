...
We believe PCR works well with our pokemon data given the existence of strong correlation among our predictors.
...
pca <- prcomp(pokemonpca,scale. = TRUE)
pca2<-pca
pca2$rotation<-pca$rotation[c(1,2,3,4,6,8,9),]
```
